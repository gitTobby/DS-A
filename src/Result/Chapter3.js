            ...
            <Fragment>
                <div className="sec_code">
                    <div className="code_bx">
                        <div className="code_title">Number.EPSLION</div>
                        <pre>
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">최대치</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">최소치</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">무한(Infinity, -Infinity)</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">크기순서</div>
                        <pre>
                            <code className="language-js">
                                {`
                                    -Infinity < Number.MIN_SAFE_INTEGER < Number.MIN_VALUE < 0 
                                    < Number.MAX_SAFE_INTEGER < Number.MAX_VALUE < Infinity;     //true
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">소수판별</div>
                        <pre>
                            <code className="language-js">
                                {`
                                    // n을 2부터 n-1까지의 수로 나눠 나머지가 0인지 확인한다.
                                    function isPrime(n) {
                                        if (n <= 1) {
                                            return false;
                                        }
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">소수판별(개선)</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">소인수분해</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">무작위 수 생성기</div>
                        <pre>
                            <code className="language-js">
                                {`
                                    ...
                                    function getRandomInt(min, max) {
                                        min = Math.ceil(min);
                                        max = Math.floor(max);
                                        return Math.floor(Math.random() * (max - min)) + min; //최댓값은 버림, 최솟값은 올림
                                    }
                                `}
                            </code>
                        </pre>
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">모듈러</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">(x^y) % p를 계산하라. (x:기저, y:지수, p:모듈러)</div>
                        <pre>
                            <code className="language-js">
                                {`
                                    // c % m = (ab) % m;
                ...
                <div className="sec_code full_size">
                    <div className="code_bx">
                        <div className="code_title">문제2: n 보다 작은 소수를 출력하라.</div>
                        <pre>
                            <code className="language-js">
                                {`
