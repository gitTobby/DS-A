    ...
    render () {
        return (
            <Fragment>
                ...
                <div className="sec_code">
                    <div className="code_bx">
                        <div className="code_title">등가 확인</div>
                        <pre>
                            <code className="language-js">
                                {`
                ...
                <div className="notice">
                    <p>type 확인을 위해서 typeof를 사용해 원하는 type가 맞는지 검증할 수 있다.</p>
                    <p>마지막으로 등가 확인을 위해 값에 대해서는 ==를 사용하고 값과 type이 모두 같은지 확인하기 위해서는 ===를 사용하자.</p>
                    <p>==와 === 연산자는 숫자, 문자열, 불리언과 같은 비객체형에만 사용할 수 있다.</p>
                </div>
            </Fragment>
        );
    }
